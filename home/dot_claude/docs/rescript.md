...
- [Complete documentation](https://rescript-lang.org/llms/manual/v12.0.0/llm-full.txt): The complete ReScript documentation including all examples and additional content
- [Abridged documentation](https://rescript-lang.org/llms/manual/v12.0.0/llm-small.txt): A minimal version of the ReScript documentation, with the essential content for quick reference
